...
export default function Details(props) {
  ...
  useEffect(() => {
    console.log("Effect after the first render");
  }, [])
  ...
  useEffect(() => {
    ...
    const weirdClickListener = () => {
    //  console.log("Random number:" + Math.random())
    }
    document.addEventListener('click', weirdClickListener);

    return () => {
     // console.log("Cleaning up the weird event listener!")
      document.removeEventListener('click', weirdClickListener);
    }
  }, [])
